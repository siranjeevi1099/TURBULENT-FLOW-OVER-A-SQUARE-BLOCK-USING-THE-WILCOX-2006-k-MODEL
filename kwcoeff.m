...
global x x_u y y_v SP Su F_u F_v mut rho u uplus tw Istart Iend ...
    Jstart Jend b aE aW aN aS aP k k_old eps E2 LARGE dudx dvdy sigmaw Bstar B_1 gamma_1 mueff omegaw
...
for I = Istart:Iend
    ...
    for J = Jstart:Jend
        ...
        % % else
            SP(I,J) = -Bstar*rho(I,J)*omegaw(I,J);
            Su(I,J) = (2.0*mut(I,J)*E2(I,J))-(2/3*rho(I,J)*k(I,J)*(dudx(I,J)+dvdy(I,J)));
        % end
